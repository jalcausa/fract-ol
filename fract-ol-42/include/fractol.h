...
/*   Updated: 2025/02/02 19:46:10 by jalcausa         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_var
{
	...
	//  Puntero a función que calcula si el punto pertenece al fractal
	int				(*form)(t_cn, int, t_cn);
	double			range; // Rango de complejos representados en pantalla
